...
export AWS_OPENSEARCH_HOST=${AWS_OPENSEARCH_HOST:""}
export AWS_OPENSEARCH_PORT=${AWS_OPENSEARCH_PORT:"443"}
export AWS_OPENSEARCH_USERNAME=${AWS_OPENSEARCH_USERNAME:""}
export AWS_OPENSEARCH_PASSWORD=${AWS_OPENSEARCH_PASSWORD:""}
