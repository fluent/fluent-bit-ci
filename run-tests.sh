...
export OPENSEARCH_IMAGE_REPOSITORY=${OPENSEARCH_IMAGE_REPOSITORY:-elasticsearch}
export OPENSEARCH_IMAGE_TAG=${OPENSEARCH_IMAGE_TAG:-7.17.3}

export ELASTICSEARCH_IMAGE_REPOSITORY=${OPENSEARCH_IMAGE_REPOSITORY:-opensearchproject/opensearch}
export ELASTICSEARCH_IMAGE_TAG=${OPENSEARCH_IMAGE_TAG:-1.3.0}
